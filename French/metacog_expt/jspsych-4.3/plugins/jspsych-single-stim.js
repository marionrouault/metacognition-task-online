...
(function($) {
	jsPsych["single-stim"] = (function() {
		...
		plugin.create = function(params) {
			...
			var trials = new Array(params.stimuli.length); // chaque trial[i] est un objet
		...
		plugin.trial = function(display_element, trial) {
			...
			var end_trial = function() {
				...
				var trial_data = {
					"rt": response.rt,
					//"stimulus": trial.a_path, // commented on April 5, 2016 because no need to store big url in database

 ...
 *
 *  This plugin runs a single XAB trial, where X is an image presented in isolation, and A and B are choices.
 *
    ...
    jsPsych.xabpositionleft = (function() {
        ...
        plugin.create = function(params) {
            ...
            for (var i = 0; i < trials.length; i++) {
                ...
                trials[i].left_key = params.left_key || 90; //Z defaults to 'w'

function draw_feedback_mtg_v2(responseSide, feedbackStim_DataURL, correct) {
    ...
    if (typeof correct !== "undefined") // If correctness of trial is provided
    {
        if (correct) // If they were correct
            feedbackContext.fillStyle = 'white'; // green square
        else // If they were incorrect
            feedbackContext.fillStyle = 'white'; // red square
    } else // If correctness of trial is not provided
    {
        feedbackContext.fillStyle = 'white'; // blue square
    }

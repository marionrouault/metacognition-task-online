...
(function($) {
  jsPsych['survey-likert-german'] = (function() {
    ...
    plugin.trial = function(display_element, trial) {
      ...
      //    value: 0, //if you want the original slider position at the extreme-left of the scale
          value: Math.ceil(trial.intervals[i] / 2), //if you want the original slider position in the middle of the scale
          min: 1,
      ...
      $("#jspsych-survey-likert-next").html('Bestätigen');
      $("#jspsych-survey-likert-next").click(function() {
        ...
        $("div.jspsych-survey-likert-slider").each(function(index) {
          ...
          var obje = {};
          obje[id] = val + 10 ; // on fait une translation de 10 pour avoir tjr 2 chiffres. 1-51 passe au range 11-61.
          // obje[id] = val ;
          if (index === 0) {
